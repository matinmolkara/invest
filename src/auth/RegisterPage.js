...
const handleSubmit = async (e) =>{
  ...
  const v1 = USER_REGEX.test(user);
        ...
        try {
            ...
            console.log(response.accessTokens);
      ...
      <p>
        ...
        <div className={styles.loginForm}>
          <div className="container">
            <div className="row">
              <div className={styles.loginForm0}>
                <div className={styles.loginForm00}>
                  <div className="row">
                    ...
                    <p ref={errRef} 
                    className={errMsg ? styles.errmsg : styles.offscreen} aria-live="assertive">
                      {errMsg}
                    </p>
                  </div>
                  <form 
                  ...
                  className="row g-1">
                    <div className="col-12">
                        ...
                        />
                        <p id={styles.uidnote} className={userFocus && user && !validName ? styles.instructions : styles.offscreen}>
                    ...
                    <div className="col-12">
                     ...
                     />
                     <p id={styles.pwdnote} className={pwdFocus  && !validPwd ? styles.instructions : styles.offscreen}>
                          <FontAwesomeIcon icon={faInfoCircle} />
                          8 to 24 charachters.<br />
                          Must include uppercase and lowercase letter . <br/>
                          Letters, a numbers and a special charachter. <br />
